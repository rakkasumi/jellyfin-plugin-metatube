...
def generate(filename, version, csproj) -> dict:
    return {
        ...
        'sourceUrl': 'https://github.com/rakkasumi/jellyfin-plugin-metatube/releases/download/'
...
def main() -> None:
    ...
    with urlopen(
            'https://raw.githubusercontent.com/rakkasumi/jellyfin-plugin-metatube/dist/manifest.json') as f:
